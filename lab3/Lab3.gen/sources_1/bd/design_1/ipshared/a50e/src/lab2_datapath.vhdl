...
begin
    ...
    triggerT_stepper : numeric_stepper
        ...
        --Used to send the trigger values to the microblaze
        output_trigger_t <= std_logic_vector(time_trigger_value);
        output_trigger_v <= std_logic_vector(volt_trigger_value);
	-------------------------------------------------------------------------------
