...
proc create_root_design { parentCell } {
  ...
  set ac_mclk_1 [ create_bd_port -dir O ac_mclk_1 ]
  set ac_adc_sdata_1 [ create_bd_port -dir I ac_adc_sdata_1 ]
  set ac_bclk_1 [ create_bd_port -dir O ac_bclk_1 ]
  set ac_dac_sdata_1 [ create_bd_port -dir O ac_dac_sdata_1 ]
  set ac_lrclk_1 [ create_bd_port -dir O ac_lrclk_1 ]
  set btn_1 [ create_bd_port -dir I -from 4 -to 0 btn_1 ]
  ...
  set tmds_1 [ create_bd_port -dir O -from 3 -to 0 tmds_1 ]
  set tmdsb_1 [ create_bd_port -dir O -from 3 -to 0 tmdsb_1 ]
  set ac_mclk_2 [ create_bd_port -dir O ac_mclk_2 ]
  set ac_dac_sdata_2 [ create_bd_port -dir O ac_dac_sdata_2 ]
  set ac_bclk_2 [ create_bd_port -dir O ac_bclk_2 ]
  set ac_lrclk_2 [ create_bd_port -dir O ac_lrclk_2 ]
  set scl_2 [ create_bd_port -dir IO scl_2 ]
  set sda_2 [ create_bd_port -dir IO sda_2 ]
  set tmds_2 [ create_bd_port -dir O -from 3 -to 0 tmds_2 ]
  set tmdsb_2 [ create_bd_port -dir O -from 3 -to 0 tmdsb_2 ]
  set ac_adc_sdata_2 [ create_bd_port -dir I ac_adc_sdata_2 ]
  set switch_2 [ create_bd_port -dir I -from 3 -to 0 switch_2 ]
  set btn_2 [ create_bd_port -dir I -from 4 -to 0 btn_2 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins My_Lab2_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_ports usb_uart] [get_bd_intf_pins axi_uartlite_0/UART]
  connect_bd_intf_net -intf_net microblaze_0_M_AXI_DC [get_bd_intf_pins microblaze_0/M_AXI_DC] [get_bd_intf_pins axi_smc_1/S00_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_M_AXI_IC [get_bd_intf_pins microblaze_0/M_AXI_IC] [get_bd_intf_pins axi_smc_1/S01_AXI]
  ...
  # Create port connections
  connect_bd_net -net My_Lab2_0_ac_bclk  [get_bd_pins My_Lab2_0/ac_bclk] \
  [get_bd_ports ac_bclk_2]
  connect_bd_net -net My_Lab2_0_ac_dac_sdata  [get_bd_pins My_Lab2_0/ac_dac_sdata] \
  [get_bd_ports ac_dac_sdata_2]
  connect_bd_net -net My_Lab2_0_ac_lrclk  [get_bd_pins My_Lab2_0/ac_lrclk] \
  [get_bd_ports ac_lrclk_2]
  connect_bd_net -net My_Lab2_0_ac_mclk  [get_bd_pins My_Lab2_0/ac_mclk] \
  [get_bd_ports ac_mclk_2]
  connect_bd_net -net My_Lab2_0_flagQ  [get_bd_pins My_Lab2_0/flagQ] \
  [get_bd_pins microblaze_0/Interrupt]
  connect_bd_net -net My_Lab2_0_tmds  [get_bd_pins My_Lab2_0/tmds] \
  [get_bd_ports tmds_2]
  connect_bd_net -net My_Lab2_0_tmdsb  [get_bd_pins My_Lab2_0/tmdsb] \
  [get_bd_ports tmdsb_2]
  connect_bd_net -net Net  [get_bd_ports scl_2] \
  [get_bd_pins My_Lab2_0/scl]
  connect_bd_net -net Net1  [get_bd_ports sda_2] \
  [get_bd_pins My_Lab2_0/sda]
  connect_bd_net -net ac_adc_sdata_2_1  [get_bd_ports ac_adc_sdata_2] \
  [get_bd_pins My_Lab2_0/ac_adc_sdata]
  connect_bd_net -net btn_2_1  [get_bd_ports btn_2] \
  [get_bd_pins My_Lab2_0/btn]
  ...
  [get_bd_pins My_Lab2_0/s00_axi_aclk]
  ...
  [get_bd_pins My_Lab2_0/s00_axi_aresetn]
  ...
  connect_bd_net -net switch_2_1  [get_bd_ports switch_2] \
  [get_bd_pins My_Lab2_0/switch]
  connect_bd_net -net sys_clock_1  [get_bd_ports sys_clock] \
  [get_bd_pins clk_wiz_1/clk_in1]

  # Create address segments
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs My_Lab2_0/S00_AXI/S00_AXI_reg] -force
