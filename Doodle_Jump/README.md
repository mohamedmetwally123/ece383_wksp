...
1.	local_address <= sample_index(10 downto 0): equivalenet to sample index mod 2048. 
2.	BRAM_selection <= sample_index(16 downto 11): equivalent to sample index / 2048.
