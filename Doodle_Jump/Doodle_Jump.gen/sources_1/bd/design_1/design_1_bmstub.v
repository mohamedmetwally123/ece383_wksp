...
module design_1 (
  ...
  (* X_INTERFACE_IGNORE = "true" *)
  output NES_latch;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.NES_CLK CLK" *)
  (* X_INTERFACE_MODE = "master CLK.NES_CLK" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.NES_CLK, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_My_FinalProject_IP_0_0_NES_clk, INSERT_VIP 0" *)
  output NES_clk;
  (* X_INTERFACE_IGNORE = "true" *)
  input NES_data;
  (* X_INTERFACE_IGNORE = "true" *)
